...
public class DataLoader {
    ...
    public void loadData() {
        ...
        // Load users
        User john = new User("example_user", "john@example.com", "password123", UserRole.NORMAL);
        User jane = new User("example_provider", "jane@example.com", "password123", UserRole.HOST);
